...
<div class="logo-head">
    <div class="inquiry-header">
        ...
        <label for="name" class="inquiry-lable">
            <div class="hover-container">
                <a href="{{ route('download.sample') }}">
                    <img src="assets/img/download.png" alt="" class="download-icon">
                    <span class="hover-text">Download Sample File</span>
                </a>
            </div>
        </label>
    </div>
        ...
        <div class="enquiry-row row ">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-inline-inquiry"><label for="name" class="inquiry-lable"><img
                    ...
                    <input type="name" class="form-control input-box-enquiry rectangle" name="city" id=""
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-inline-inquiry" id="date">
                    ...
                    <input type="text" class="form-control input-box-enquiry rectangle" name="enquirydate" id="dateField"
                        placeholder="Enquiry Date : DD MMM YYYY" readonly>
                </div>
                <div class="input-inline">
                    <span class="text-danger">
                        @error('enquirydate')
