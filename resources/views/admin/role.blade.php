            ...
            <div class="enquiry-row row ">
             ...
             <div class="enquiry-title">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      <div class="form-check form-check-inline form-role">
                        <input class="form-check-input" type="checkbox" name="role_permission[]" value="PurposalDetails">
                        <label class="form-check-label" for="inlineCheckbox3"id="inlineCheckbox3">Purposal Details</label>
                      </div>
                    </div>
                    <div class="form-group col-md-6">
                      <div class="form-check form-check-inline form-role">
                        <input class="form-check-input" type="checkbox" name="role_permission[]" value="PendingFollowup">
